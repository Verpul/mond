...
return [
    ...
    */
    ...
    'alpha_space'          => 'Поле :attribute должно содержать минимум 3 буквы',
    /*
    |--------------------------------------------------------------------------
    ...
    */
    'custom' => [
        'purpose' => [
            'unique' => 'Сочетание полей Назначение и Логин не уникальны',
            'numeric' => 'Назначение не выбрано'
        ],
        'surname' => [
            'unique' => 'Сотрудник с такой фамилией и именем уже существует'
        ],
        'eds' => [
            'unique' => 'Такая :attribute уже находится на носителе'
        ],
        'employee' => [
            'unique' => 'Сотрудник с такой ЭЦП уже существует'
        ],
        'company' => [
            'numeric' => 'Организация не выбрана'
        ]
    ],
    /*
    |--------------------------------------------------------------------------
    ...
    */
    'attributes' => [
        ...
        'employee'              => 'Сотрудник',
        'eds'                   => 'ЭЦП',
        'created'               => 'Дата начала действия',
        'expired'               => 'Дата окончания действия',
        'purpose'               => 'Назначение',
        'company'               => 'Организация',
    ],
];