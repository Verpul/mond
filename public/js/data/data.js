...
$(document).ready(function() {
  ...
  //Блокировать кнопку показа всех записей, если их меньше 10
	var rowCount = $('table tr').length;
  var lastRow = $('table tr:last th').html();

	if(rowCount < 12 && lastRow > 12){
		$('#show').attr('disabled', '');
	};
	...
	//Если поле поиска пустое, ничего не должно происходить
	...
	//Очистить поле поиска перед очисткой результатов поиска
